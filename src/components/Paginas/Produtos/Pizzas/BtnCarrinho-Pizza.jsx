...
export default function BtnCarrinho({ totalCusto, PIZZA_MISTA, Produto, SaboresSelecionados, adicionalSelecionado, observacoes, totalCompra, quantidadeTotal, ID_GRUPO_OPCOES }){
