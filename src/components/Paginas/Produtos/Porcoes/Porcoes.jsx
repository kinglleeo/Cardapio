                    ...
                    <div className='caixa-css'>
                        <div className='caixa-items' key={data.id}>
                            ...
                            <div className='caixa-2'>
                                ...
                                <div>
                                    {data.adicionais === false ?(<button onClick={()=> handleAddCart(data.sabor, data.descricao, data.valor)}> adicionar </button>):(<button onClick={()=> handleAddTamanho(data.sabor, data.descricao, data.valor)}>botao2</button>)}
                                </div>
                            </div>
